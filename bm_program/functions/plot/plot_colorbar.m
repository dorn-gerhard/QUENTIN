function colmap = plot_colorbar(n_index, neg_color, pos_color, nobar)
if nargin < 1 || isempty(n_index), n_index = 64; end
if nargin < 2 || isempty(neg_color), neg_color = [0, 100, 255]/255; end
if nargin < 3 || isempty(pos_color), pos_color = [255, 0, 0]/255; end
...
% find colors
third_color = [255, 190, 60]/255;
first_color = [0, 190, 190]/255;
