function [K,I,Sig, Bat, Tab_cut, status] = born_markov_full_dynamic(En, contact_site, Tab, Mu, Coupling, Beta, Bat, condor, Energy_cut, Energy_cut_2, run_id, min_en_ind, eigenvalue_tolerance)
...
break_set = [min_en_ind:10:numel(energ_sort_index), final_block_index];
